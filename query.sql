...
CREATE TABLE `school`.`students` ( `id` INT NOT NULL AUTO_INCREMENT ,`school` VARCHAR(50) NOT NULL, `name` VARCHAR(50) NOT NULL , `created_at` DATETIME NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;

CREATE TABLE `school`.`grades` ( `id` INT NOT NULL AUTO_INCREMENT , `student_id` INT NOT NULL , `grade` INT NOT NULL , `created_at` DATETIME NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
